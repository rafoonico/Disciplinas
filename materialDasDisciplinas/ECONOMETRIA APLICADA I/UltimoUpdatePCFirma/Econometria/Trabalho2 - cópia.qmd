...
# Outra alternativo... a transformação Yeo-Johnson funciona para números negativos. Só que ela precisa de um lambda.
# Método: gera um lambda via BoxCox, somando o absoluto do mínimo em toda a coluna de alavancagem. Pega o lambda,
# transforma via YeoJohnson a alavancagem original, e prossegue com a análise.

# Base_2023_alt2 <- Base_2023
# Base_2023_alt2$alavancagem <- Base_2023_alt2$alavancagem+abs(min(Base_2023_alt2$alavancagem))+1
# 
# # Realizando a transformação de BoxCox
# lambda_boxcox=MASS::boxcox(lm(alavancagem ~ nivel_de_gov + log(tamanhoEmpresa) +
#                             imobilizado + retornoSobreAtivo + qDeTobin + ROA + setoreconomatica + trim + ano,data=Base_2023_alt2)) 
# 
# lambda=lambda_boxcox$x[lambda_boxcox$y==max(lambda_boxcox$y)]
# 
# Base_2023_alt <- Base_2023
# Base_2023_alt$log_alavancagem <-  VGAM::yeo.johnson(Base_2023_alt2$alavancagem , lambda = lambda)
# 
## Crosssection
